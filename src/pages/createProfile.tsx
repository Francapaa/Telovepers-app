  ...
  return (
    <div className="onboarding-container">
      ...
      <div className="onboarding-content">
        ...
        {currentStep === 1 && (
          <div className="step">
            <h2 className ="title-step-1">Cuéntanos sobre ti</h2>
        ...
        {currentStep === 2 && (
          <div className="step">
            <h2 className = "title-step-2">¿Dónde te encuentras?</h2>
        ...
        {currentStep === 3 && (
          <div className="step">
            <h2 className = "title-step-3">¿Tus Preferencias de trabajo?</h2>
            <div className="form-group">
        ...
        {currentStep === 4 && (
          <div className="step">
            <h2 className = "title-step-4">¿Cuál es tu rol principal?</h2>
        ...
        {currentStep === 5 && (
          <div className="step">
            <h2 className = "title-step-5">¿Cuáles son tus habilidades?</h2>
        ...
        {currentStep === 6 && (
          <div className="step">
            <h2 className= "title-step-6">¿Qué tipo de co-founder buscas?</h2>
        ...
        {error && <div className="error-message">{"No pudimos crear el perfil, intentelo mas tarde"}</div>}
